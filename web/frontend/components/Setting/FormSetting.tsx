...
const FormSetting = () => {
    ...
    return (
        <Box sx={{display: 'flex', flexWrap: 'wrap', width: '100%', height:650}}>
                ...
                <Typography variant="body2" sx={{my: 1.5, ml: 2}}>Form Page</Typography>
                <TextField
                    id='form_title'
                    label="Form Title"
                ...
                />
                    ...
                    >
                        <Button type="submit" variant="contained" sx={{ mr: 0, ml: 'auto' }} >Save Form Setting</Button>
                    </Box>
                </ValidatorForm>
        </Box>
    )
