...
const QuoteTable: React.FC<IPropQuoteTable> = (props) => {
  ...
  const toggleModal = useCallback((quote: ParsedQuote, status: number) => {
    setActive((active) => !active)
    console.log('active', active)
    setPropModal(quote)
    console.log('propsModal', quote)
    updateStatus(quote.id, 1)
    setStatus(status)
  }, [])
  ...
  useEffect(() => {
    ...
    quotesTables.map((quote: ParsedQuote) => {
      ...
      tempColumn[4] =
        <div style={{}}>
          <img src={quote.product.selected_product.image || ''} alt="" width="40%"
      ...
      if (quote.status === 0) {
        tempColumn[6] =
          <div style={{ color: '#bf0711' }}>
            <Button monochrome outline size="slim">unread</Button>
          </div>
      } else {
        tempColumn[6] = <Button size="slim">read</Button>
      }
  ...
  const updateStatus = useCallback(async (id: number, status: number): Promise<boolean> => {
    try {
                      ...
                      <LegacyStack vertical>
                          ...
                          <LegacyStack.Item>
                              ...
                              >
                                  ...
                                  <Grid.Cell area="orders">
                                      <Buttonholder label="copy" childAlign="end" copiedValue={propModal.name}/>
                                  </Grid.Cell>
                              </Grid>
                          </LegacyStack.Item>
                          <Divider/>
                          <LegacyStack.Item>
                              ...
                              >
                                  ...
                                  <Grid.Cell area="orders">
                                      <Buttonholder label="copy" childAlign="end" copiedValue={propModal.email}/>
                                  </Grid.Cell>
                              </Grid>
                          </LegacyStack.Item>
                          <Divider/>
                          <LegacyStack.Item>
                              ...
                              >
                                  ...
                                  <Grid.Cell area="orders">
                                      <Buttonholder label="copy" childAlign="end" copiedValue={propModal.message}/>
                                  </Grid.Cell>
                              </Grid>
                          </LegacyStack.Item>
                      </LegacyStack>
